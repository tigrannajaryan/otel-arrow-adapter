...
func (c *metricsServiceClient) Export(ctx context.Context, in *ExportMetricsServiceRequest, opts ...grpc.CallOption) (*ExportMetricsServiceResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/otlpdict.proto.collector.metrics.v1.MetricsService/Export", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _MetricsService_Export_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/otlpdict.proto.collector.metrics.v1.MetricsService/Export",
	}
...
var MetricsService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "otlpdict.proto.collector.metrics.v1.MetricsService",
	...
	Metadata: "otlpdict/proto/collector/metrics/v1/metrics_service.proto",
}
